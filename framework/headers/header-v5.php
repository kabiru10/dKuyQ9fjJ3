...
<div class="header-v5">
	...
	<header id="header">
<<<<<<< HEAD
		<div class="zhane-row" style="padding-top:<?php echo $smof_data['margin_header_top']; ?>;padding-bottom:<?php echo $smof_data['margin_header_bottom']; ?>; overflow:hidden;">
...
=======
		<div class="zhane-row" style="padding-top:<?php echo $zdata['margin_header_top']; ?>;padding-bottom:<?php echo $zdata['margin_header_bottom']; ?>; overflow:hidden;">
